...
-- 3) (AINDA NÃO DEU CERTO) Liste o nome do cliente, o e-mail, o logradouro, o número e a cidade, 
...
-- cidade AS 'Cidade'
-- FROM clientes c
-- INNER JOIN clientes_enderecos on c.id_cliente = c.id_cliente
-- INNER JOIN enderecos ce ON ce.ID_enderecos = ce.ID_enderecos
